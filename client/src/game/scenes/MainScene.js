...
import PlayerA from "@/game/Player";
import PlayerB from "@/game/PlayerB";
...
class MainScene extends Scene {
  ...
  preload() {
    PlayerA.preload(this);
    // PlayerB.preload(this)
  }
  ...
  createMap() {
    ...
    // this.socket.on("createPlayer", (playerA) => {

    // this.player = this.createPlayerA();
    this.player = this.createPlayerA();
    // });
  ...
  createPlayerA() {
    const player = this.physics.add.existing(
      new PlayerA(this, 350, 250, "player1")
    );
  ...
  createPlayerB() {
    const player = this.physics.add.existing(
      new PlayerB(this, 400, 250, "player2")
    );
    //scalling player's height and width
    player.displayHeight = 15;
    player.displayWidth = 15;
